...
parser = argparse.ArgumentParser(description="Embed data payloads inside of ordinary images or video with "
                                             "high-performance 2-D barcodes. ")

parser.add_argument('--write',
                    help='This is the primary function in creating BitGlitter streams from files.  Please see Wiki page' 
